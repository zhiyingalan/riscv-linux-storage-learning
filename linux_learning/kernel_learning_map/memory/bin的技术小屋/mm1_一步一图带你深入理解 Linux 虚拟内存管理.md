...
![img](https://pic1.zhimg.com/v2-72275ea489e68213639a11f82cccaeea_1440w.jpg)
...
![img](https://picx.zhimg.com/v2-199c9bbc4a6fa2cea83b95c9056e72b7_1440w.jpg)
...
![img](https://pic1.zhimg.com/v2-900fc9c7424028197574ee15626ccca2_1440w.jpg)
...
![img](https://pic2.zhimg.com/v2-81359b37ae8d9c563628c13ad368d547_1440w.jpg)
...
![img](https://pic4.zhimg.com/v2-6a59ffc2afa10336d9537bc188aee2ff_1440w.jpg)
...
![img](https://pica.zhimg.com/v2-2997bf19bf3cf78b9d427ba37af4ed5a_1440w.jpg)



上面介绍的这些全局变量和静态变量都是在编译期间就确定的，但是我们程序在运行期间往往需要动态的申请内存，所以在虚拟内存空间中也需要一块区域来存放这些动态申请的内存，这块区域就叫做堆。注意这里的堆指的是 OS 堆并不是 JVM 中的堆。

![img](https://pica.zhimg.com/v2-c5b1cd86f65459abdef7cc9e237d540c_1440w.jpg)
...
![img](https://picx.zhimg.com/v2-fd4e3c38a3abf5c9c29387d82fee9e91_1440w.jpg)



最后我们在程序运行的时候总该要调用各种函数吧，那么调用函数过程中使用到的局部变量和函数参数也需要一块内存区域来保存。这一块区域在虚拟内存空间中叫做栈。

![img](https://picx.zhimg.com/v2-179627b3c76f834c905f0b1085da4c1b_1440w.jpg)
...
![img](https://pic1.zhimg.com/v2-6c48dce505b02cbe9d49259bce74c08c_1440w.jpg)
...
![img](https://pic2.zhimg.com/v2-4dc50f7f3e5542287230baf1adf91129_1440w.jpg)
...
![img](https://pic2.zhimg.com/v2-ea96331b44f562abfa33dfdc3d1872b3_1440w.jpg)
...
![img](https://pica.zhimg.com/v2-c7dcb8e62b3029f29bfbfaeff87fd30c_1440w.jpg)
...
![img](https://picx.zhimg.com/v2-4da3d511c1efacfdd0f6e1340c14fee9_1440w.jpg)
...
![img](https://pic3.zhimg.com/v2-705089a1d31bddab3f774051225bbcbe_1440w.jpg)
...
![img](https://pic2.zhimg.com/v2-f53cf113501c25850e09bb4641f7a97d_1440w.jpg)
...
![img](https://pica.zhimg.com/v2-9877a509988d25cae7df955f4c3ccb86_1440w.jpg)
...
![img](https://pica.zhimg.com/v2-af91aec5c3edc7c13ae1ba2afcc0a8fa_1440w.jpg)
...
![img](https://pic1.zhimg.com/v2-0055f28b2d7c5d2d7b5c22e1d18f8838_1440w.jpg)
...
![img](https://pic3.zhimg.com/v2-a0cf1f02cc61f843496e8d0ddb2ba0a4_1440w.jpg)
...
![img](https://pic2.zhimg.com/v2-de7b6479bc40da70b71211c00f64a0fb_1440w.jpg)
...
![img](https://pic3.zhimg.com/v2-3ace7080594e2ce55bff74759070b186_1440w.jpg)
...
![img](https://pica.zhimg.com/v2-4ceccb12795b0689d1041b0b2b2e8f8a_1440w.jpg)
...
![img](https://pic2.zhimg.com/v2-1d4a98004a56a4f39ea1cec3bd6497bf_1440w.jpg)



如图所示内存条上黑色的元器件就是存储器模块（memory module）。多个存储器模块连接到存储控制器上，就聚合成了主存。

![img](https://pic3.zhimg.com/v2-8250e1e83351be0ac63efdd4980d67ae_1440w.jpg)

内存结构.png

而 DRAM 芯片就包装在存储器模块中，每个存储器模块中包含 8 个 DRAM 芯片，依次编号为 0 - 7 。

![img](https://pic2.zhimg.com/v2-a4e7810066c60d2a8b419078b758e993_1440w.jpg)
...
![img](https://picx.zhimg.com/v2-1a81a7e85a25d4b6a606ecab03acde4d_1440w.jpg)
...
![img](https://picx.zhimg.com/v2-47cc0cd3f1be629898746cee6e11458b_1440w.jpg)
...
![img](https://picx.zhimg.com/v2-1ce467976f78f72f11604fd800714021_1440w.jpg)
