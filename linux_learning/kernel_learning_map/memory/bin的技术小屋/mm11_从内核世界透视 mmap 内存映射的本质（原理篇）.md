...
![img](https://pic3.zhimg.com/v2-602756f5bd909c7ac4c66bd2e9843784_1440w.jpg)

本文概要.png

在上一篇文章 **《一步一图带你构建 Linux 页表体系》** 中，笔者为大家介绍了内存映射最为核心的内容 —— 页表体系。通过一步一图的方式为大家展示了整个页表体系的演进过程，并在这个过程中逐步揭开了整个页表体系的全貌。

![img](https://pic4.zhimg.com/v2-4023cdbb14777f1ecd2dea398551aaed_1440w.jpg)
...
笔者在之前的文章**《一步一图带你深入理解 Linux 虚拟内存管理》** 中曾为大家详细介绍过进程虚拟内存空间的布局，在进程虚拟内存空间的布局中，有一段叫做**文件映射与匿名映射区**的虚拟内存区域，当我们在用户态应用程序中调用 mmap 进行内存映射的时候，所需要的虚拟内存就是在这个区域中划分出来的。

![img](https://pic1.zhimg.com/v2-d2b60ecdffb6338ac5df49735631a4cc_1440w.jpg)
...
![img](https://pica.zhimg.com/v2-9331378acb07ae87ad6e6610f0f7d290_1440w.jpg)


如果我们通过 mmap 映射的是磁盘上的一个文件，那么就需要通过参数 fd 来指定要映射文件的描述符（file descriptor），通过参数 offset 来指定文件映射区域在文件中偏移。

![img](https://picx.zhimg.com/v2-23e0064b8b7032af0b793d1cfd1531d7_1440w.jpg)
...
![img](https://pic4.zhimg.com/v2-7e5ce667be185bdf3ccc86a312eea6db_1440w.jpg)
...
![img](https://pic3.zhimg.com/v2-2041dc43a70dc40c4c70084e2374f976_1440w.jpg)


或者 PTE 中的 P 位为 0 ，这些都是表示虚拟内存还未与物理内存进行映射。

![img](https://pic1.zhimg.com/v2-7436b574f1f91fd3d2b8ca8a5fc303ea_1440w.jpg)
...
![img](https://pic2.zhimg.com/v2-8879ca8bbd9fa0b8a130734c3f6ea5d1_1440w.jpg)
...
![img](https://picx.zhimg.com/v2-cdefbe0f6daa6458120cf92f2265ac9b_1440w.jpg)
...
![img](https://pic4.zhimg.com/v2-23820e7004cd57d0e366bd2e1f3b91db_1440w.jpg)
...
![img](https://picx.zhimg.com/v2-c53478091eb3118c53089c338695baa5_1440w.jpg)
...
![img](https://picx.zhimg.com/v2-946e4ac795ffd4c5a505509e763f6251_1440w.jpg)
...
![img](https://pic4.zhimg.com/v2-d85f0e9014772f804fc71e4b1d599e55_1440w.jpg)


当内核处理完缺页中断之后，mmap 私有文件映射在内核中的关系图就变成下面这样：

![img](https://pica.zhimg.com/v2-73ecf51536df3dfe9efd112a6991c414_1440w.jpg)
...
![img](https://pic2.zhimg.com/v2-4249bee5cdc129e1ccb80a804e07d545_1440w.jpg)
...
![img](https://pic2.zhimg.com/v2-36970d3d0b65d851e18d8c9cbaf88f81_1440w.jpg)
...
![img](https://pica.zhimg.com/v2-f514b4b29bd581bff7cc0168fc48e2c4_1440w.jpg)
...
![img](https://picx.zhimg.com/v2-6ed62d1a288d24a08f18ed63c3d4fc43_1440w.jpg)
...
![img](https://pica.zhimg.com/v2-b6ff6f3c68d1d5fc0be0d402a47223cc_1440w.jpg)
...
![img](https://pic3.zhimg.com/v2-a63aefed55930fa2cbeaf102c8ab51ba_1440w.jpg)
...
![img](https://pic1.zhimg.com/v2-baa0e2bc6ce6fe5bc9fb2d1d9d40ce1c_1440w.jpg)
...
![img](https://pic2.zhimg.com/v2-dc28cfa1c20d62172c509de63ab7c975_1440w.jpg)
...
![img](https://pica.zhimg.com/v2-1ad7fbd17ba204976726624338ff5512_1440w.jpg)
...
![img](https://pica.zhimg.com/v2-c9c13a0aab8a0900d66f573c8305999e_1440w.jpg)
...
![img](https://pic4.zhimg.com/v2-1b4d5aca3663b69337a91fdb50cd5b07_1440w.jpg)
...
![img](https://picx.zhimg.com/v2-4e6ab12407030c92c7148a8c07fd405d_1440w.jpg)
...
![img](https://pic2.zhimg.com/v2-9fe391fdeb0316099bf57591862e649d_1440w.jpg)
...
![img](https://pic4.zhimg.com/v2-6389f43cf4241f74bf921a325f287951_1440w.jpg)
